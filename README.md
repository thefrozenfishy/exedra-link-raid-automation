...
* ``boss`` Which boss is currently being fought, is used for the tool to know what difficulty you are currently fighting. Options: ``Sandbox``, ``Wheel``, ``Spindle``, ``Horse``, ``AI``, ``Yume`` and ``Walpy``.
